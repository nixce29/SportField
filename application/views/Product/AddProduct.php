                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="Product_price" placeholder="Input Product price">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="Product_Amount" class="col-sm-2 col-form-label">Amount</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="Product_Amount" placeholder="Input Product Amount">
                      </div>
                    </div>
